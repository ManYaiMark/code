...
if select_box == 'intro':
    ...
    title_write=st.button("translate")
    if title_write == False:
        up_ti.write("**Water potability refers to the suitability of water for consumption by humans without causing any adverse health effects. Potable water must meet certain standards and guidelines established by regulatory bodies such as the World Health Organization (WHO) and the Environmental Protection Agency (EPA) to ensure its safety.**\n\n**The quality of water can be affected by various factors, including natural contaminants such as minerals and microorganisms, as well as man-made pollutants such as chemicals and industrial waste. The presence of harmful substances in water can cause health problems such as gastrointestinal illness, reproductive problems, and even cancer.**\n\n**To ensure water potability, water treatment processes are used to remove contaminants and ensure that the water is safe for consumption. These processes may include filtration, disinfection, and the addition of chemicals to remove impurities.**\n\n")
    else:
        up_ti.write("**ความสามารถในการผลิตน้ำ หมายถึง ความเหมาะสมของน้ำสำหรับการบริโภคของมนุษย์โดยไม่ก่อให้เกิดผลเสียต่อสุขภาพ น้ำดื่มต้องเป็นไปตามมาตรฐานและหลักเกณฑ์ที่กำหนดโดยหน่วยงานกำกับดูแล เช่น องค์การอนามัยโลก (WHO) และสำนักงานคุ้มครองสิ่งแวดล้อม (EPA) เพื่อความปลอดภัย**\n\n**คุณภาพของน้ำอาจได้รับผลกระทบจาก ปัจจัยต่างๆ ได้แก่ สารปนเปื้อนจากธรรมชาติ เช่น แร่ธาตุและจุลินทรีย์ ตลอดจนสารมลพิษที่มนุษย์สร้างขึ้น เช่น สารเคมีและของเสียจากโรงงานอุตสาหกรรม การปรากฏตัวของสารอันตรายในน้ำอาจทำให้เกิดปัญหาสุขภาพ เช่น โรคระบบทางเดินอาหาร ปัญหาระบบสืบพันธุ์ และแม้แต่มะเร็ง**\n\n**เพื่อให้แน่ใจว่าน้ำดื่มได้ กระบวนการบำบัดน้ำจะใช้เพื่อกำจัดสิ่งปนเปื้อนและทำให้แน่ใจว่าน้ำมี ปลอดภัยต่อการบริโภค กระบวนการเหล่านี้อาจรวมถึงการกรอง การฆ่าเชื้อ และการเติมสารเคมีเพื่อขจัดสิ่งเจือปน**\n\n")
